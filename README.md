...
### [CollabLearn](https://collablearn.in)
Full-stack collaboration platform built with Next.js, Express, Prisma, and PostgreSQL. Key technical features:
- Provider-agnostic AI orchestration with adaptive failover
- SSE-based streaming workflows
- Redis-backed caching and persistent planning state
